    ...
    return (
        <>
            <div className={`services-flex ${isMobile ? '' : 'desktop'}`}>
                <ServiceCard
                    ImagePath="src/assets/media/static/carro-3.jpg"
                    Route="./boudoir"
                    Title="Boudoir"
                    ...
                    />
                <ServiceCard
                    ImagePath="src/assets/media/static/sussie-4.jpg"
                    Route="./portrait"
                    Title="Porträtt"
            ...
            <div className={`services-flex ${isMobile ? '' : 'desktop'}`}>
                <ServiceCard
                    ImagePath="src/assets/media/static/Malin-4.jpg"
                    Route="./modelling"
                    Title="Modell"
                    ...
                    />
                <ServiceCard
                    ImagePath="src/assets/media/static/linda brud-4.jpg"
                    Route="./weddings"
                    Title="Bröllop"

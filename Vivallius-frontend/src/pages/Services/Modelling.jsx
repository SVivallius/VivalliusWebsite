...
function Modelling() {
    ...
    return (
        ...
        <div className={`category-flex ${isMobile ? '' : 'desktop'}`}>
            ...
            <div className={`category-container ${isMobile ? '' : 'desktop'}`}>
                <h1>Modell</h1>
                <p>Det här är en genre som är lite svår att beskriva och förklara. Det handlar oftast mer om att "spela en karaktär" än att porträttera en person.<br/>Det kan vara allt ifrån att spela geisha, samuraj eller yxmördare. Idéerna kan komma från mig som fotograf eller från dig som modell.</p>
                ...
                <p>Om vi båda tänder på idén så innebär det ingen kostnad för dig, eller vi delar på ev omkostnader. Båda får bilder att använda i olika sammanhang.</p>
                ...
                <p>Din trygghet är viktig och en förutsättning för att bra resultat.</p>
            </div>
        </div>

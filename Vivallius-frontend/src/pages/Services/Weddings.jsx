    ...
    return (
        ...
        <div className={`weddings-bottom ${isMobile ? '' : 'desktop'}`}>
            ...
            <div className={`category-flex ${isMobile?'':'desktop'}`}>
                <div className={`category-container ${isMobile?'':'desktop'}`}>
                    <ul>
                        <li><span className="bold">Förberedelser:</span><br/>Dokumenterar förberedelserna inför vigseln som t.ex smink, hår och påklädning. Kan inkludera brud, brudgum, tärnor och bestman.</li>

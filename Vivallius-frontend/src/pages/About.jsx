        ...
        <>
            <div className={`about-container ${isMobile ? '' : 'desktop'}`}>
                ...
                <div className={`about-description ${isMobile ? '' : 'desktop'}`}>
                    ...
                    <h3>UPPLEVELSEN</h3>
                    <p>Som fotograf har jag stor förståelse för att det kan vara en både utsatt och obekväm sittuation att befinna sig framför en kamera. Därför ser jag det som en av mina stärsa uppfifter som fotograf att skapa så bra förutsättningar som möjligt.</p>
                    <p>Därför föregås varje fotografering av ett förmöte. Det kan ske via MS Teams, Skype, messenger eller på annat sätt. Där går vi tillsammans egenom vad som kommer hända och hur allt går till, bestämmer plats och tid mm.</p>
